...
class Descarte(db.Model):
    ...
    def __init__(self, nome, localidade, item, quantidade):
        self.nome = nome
...
def add():
    if request.method == 'POST':
        descarte = Descarte(request.form['nome'], request.form['localidade'], request.form['item'], request.form['quantidade'])
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        descarte.localidade = request.form['localidade']
